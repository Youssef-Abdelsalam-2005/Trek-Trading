...
strategy_status = ENUM(
    "generated", "backtesting", "backtested", "skeptic_pending",
    "skeptic_passed", "skeptic_failed", "paper_trading", "paper_passed",
    "paper_failed", "live", "halted", "killed", "retired",
...
def upgrade() -> None:
    op.execute("CREATE TYPE strategy_status AS ENUM ('generated','backtesting','backtested','skeptic_pending','skeptic_passed','skeptic_failed','paper_trading','paper_passed','paper_failed','live','halted','killed','retired')")
    op.execute("CREATE TYPE task_status AS ENUM ('pending','running','completed','failed')")
    op.execute("CREATE TYPE trade_side AS ENUM ('buy','sell')")
    op.execute("CREATE TYPE trade_status AS ENUM ('filled','failed','skipped')")
